...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Dashboard | Tecnoshop</title>
			  ...
			  <div class="row">
			    <div class="col-md-12">
			    	<div class="row">
						...
						<div class="col-2">
							<div class="option-user" id="proveedores">
						...
						<div class="col-2">
							<div class="option-user" id="productos">
						...
						<div class="col-2">
							<div class="option-user" id="ventas">
						...
						<div class="col-2">
							<div class="option-user" id="reportes">
